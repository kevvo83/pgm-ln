...
% CPD look like this for dominant traits
% -------------------------
%isDominant:         1
%Genotype:       TT  tT  tt
%Phenotype_Yes:  1   1   0
...
% CPD looks like this for recessive traits
% -------------------------
%isDominant:         1
%Genotype:       TT  tT  tt
%Phenotype_Yes:  0   0   1
...
if isDominant
    assign = [1,1;1,2;2,3];
    inds = AssignmentToIndex(assign,phenotypeFactor.card);
else
    assign = [2,1;2,2;1,3];
    inds = AssignmentToIndex(assign,phenotypeFactor.card);
end;

phenotypeFactor.val(inds) = 1;
